$(document).ready(function(){
	...
	/***** 공통 함수(start) *****/	
		...
		$("nav.nav_01 > ul.nav_02").mouseenter(function(){ 
				$(this).toggleClass('on');
		});
		$("nav.nav_01 > ul.nav_02").mouseleave(function(){ 
				$(this).toggleClass('on');
		});
	...
	window.onload = function(){
			...
			var si_01 = null; 
				...
				$inner_list.style.marginLeft = "-212px";
			...
			function move_ul(_direction){
					//click_Event = false;
					stop_si(); 
					$inner_list.style.marginLeft = _direction =="prev" ? "0px" : "-424px" ;
